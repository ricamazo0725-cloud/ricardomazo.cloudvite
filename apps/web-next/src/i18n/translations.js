...
export const translations = {
  es: {
    ...
    projects: {
      eyebrow: "Proyectos",
      heading: "Proyectos",
      intro: "Trabajo real, con la tecnología que mejor se ajusta a cada caso.",
      loading: "Cargando...",
      empty: "Todavía no hay proyectos cargados. Vuelve pronto.",
      cta: "Ver sitio",
    },
    admin: {
      title: "Panel admin",
      signOut: "Cerrar sesión",
      tabs: { content: "Contenido", services: "Servicios", experience: "Experiencia", projects: "Proyectos" },
      saved: "Guardado ✓",
      save: "Guardar",
      remove: "Quitar",
      delete: "Eliminar",
      ...
      projectsEditor: {
        ...
        fieldTitle: "Título",
        fieldDescription: "Descripción",
        fieldTag: "Tecnología (ej. WordPress, React + Supabase)",
        fieldUrl: "URL del proyecto",
        order: "Orden",
      },
    },
  },
  en: {
    ...
    projects: {
      eyebrow: "Projects",
      heading: "Projects",
      intro: "Real work, using whichever technology fits each project best.",
      loading: "Loading...",
    ...
    admin: {
      title: "Admin panel",
      signOut: "Sign out",
      tabs: { content: "Content", services: "Services", experience: "Experience", projects: "Projects" },
      saved: "Saved ✓",
      save: "Save",
      remove: "Remove",
      delete: "Delete",
      ...
      projectsEditor: {
        ...
        fieldTitle: "Title",
        fieldDescription: "Description",
        fieldTag: "Technology (e.g. WordPress, React + Supabase)",
